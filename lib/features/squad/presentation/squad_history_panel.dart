...
class _SquadHistorySheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_SquadHistorySheet> createState() => _SquadHistorySheetState();
}
...
class _RunDetailState extends ConsumerState<_RunDetail> {
  ...
  @override
  Widget build(BuildContext context) {
    final agentRunsAsync = ref.watch(agentRunsForSquadProvider(widget.run.id));
...
class _AgentRunCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasOutput = agentRun.output != null && agentRun.output!.isNotEmpty;
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          onPressed: () {
                            Clipboard.setData(
                              ClipboardData(text: agentRun.output!),
                            );
